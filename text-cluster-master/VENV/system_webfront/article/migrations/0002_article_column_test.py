# Generated by Django 3.1 on 2019-12-21 11:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intro', models.CharField(default='', max_length=256, verbose_name='栏目简介')),
            ],
            options={
                'verbose_name': '栏目',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('colum', models.ManyToManyField(to='article.Column', verbose_name='归属栏目')),
            ],
            options={
                'verbose_name': '教程',
